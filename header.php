        ...
        <ul class="navbar-nav align-items-center justify-content-end w-25">
          ...
          <li class="nav-item d-flex">
            <?php if ($role == 'anonymous') { ?>
              <a href="/student046/dwes/form/customer/form_customer_login.php" class="
              <?php
              if (isset($_COOKIE['046_theme'])) {
                if (strcmp($_COOKIE['046_theme'], "purple") === 0) {
                } elseif (strcmp($_COOKIE['046_theme'], "blue") === 0) {
              ...
              } ?> nav-link rounded-2 mx-2">Log in</a>
              <a href="/student046/dwes/form/customer/form_customer_insert.php" class="
              <?php
              if (isset($_COOKIE['046_theme'])) {
                if (strcmp($_COOKIE['046_theme'], "purple") === 0) {
                } elseif (strcmp($_COOKIE['046_theme'], "blue") === 0) {
              ...
              } ?> nav-link rounded-2">Register</a>
            <?php } else { ?>
              <a href="/student046/dwes/db/customer/db_customer_logout.php" class="
              <?php
              if (isset($_COOKIE['046_theme'])) {
                if (strcmp($_COOKIE['046_theme'], "purple") === 0) {
                } elseif (strcmp($_COOKIE['046_theme'], "blue") === 0) {
