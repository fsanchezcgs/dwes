...
<form action="/student046/dwes/db/db_reservation_update.php" method="post" class="shadow bg-white rounded p-4 d-flex flex-column align-items-center m-5">
    <?php
    ...
    <div class="form-group">
        ...
        <input type="text" name="customer_id" class="form-control" value="<?php echo $reservation[0]['customer_id']; ?>">
    </div>
    <div class="form-group">
