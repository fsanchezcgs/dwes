...
<form action="/student046/dwes/form/reservation/form_reservation_delete.php" method="post" class="shadow bg-white rounded p-4 d-flex flex-column align-items-center m-5">
