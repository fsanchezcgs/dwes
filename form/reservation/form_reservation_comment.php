...
<form action="/student046/dwes/db/reservation/db_reservation_comment.php" method="post" class="shadow bg-white rounded p-4 d-flex flex-column align-items-center m-5">
