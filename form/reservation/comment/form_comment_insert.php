...
<form action="/student046/dwes/db/reservation/comment/db_comment_insert.php" method="post" class="shadow bg-white rounded p-4 d-flex flex-column align-items-center m-5">
  ...
  <input type="number" name="reservation_number" value="<?php echo $_POST['reservation_number']; ?>" hidden>
</form>
